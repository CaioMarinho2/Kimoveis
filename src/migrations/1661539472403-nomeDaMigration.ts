...
export class nomeDaMigration1661539472403 implements MigrationInterface {
    name = 'nomeDaMigration1661539472403'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "properties" ("id" uuid NOT NULL, "sold" boolean NOT NULL DEFAULT false, "value" numeric(12,2) NOT NULL, "size" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "adressesId" uuid NOT NULL, "categoryId" uuid, CONSTRAINT "UQ_672d1164dcbb054275e37c049ff" UNIQUE ("adressesId"), CONSTRAINT "REL_672d1164dcbb054275e37c049f" UNIQUE ("adressesId"), CONSTRAINT "PK_2d83bfa0b9fcd45dee1785af44d" PRIMARY KEY ("id"))`);
